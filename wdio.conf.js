...
exports.config = {
  ...
  beforeFeature: function (uri, feature) {
    ...
    allureReporter.addStep("Staring feature : " + feature.name);
    console.log("Indians are India ");
  ...
  beforeStep: function (step, scenario, context) {
    console.log("Before every step started ");
  },
  /**
   *
  ...
  afterStep: function (step, scenario, result, context) {
    ...
    cucumberJson.attach("just a string Indrasen");
